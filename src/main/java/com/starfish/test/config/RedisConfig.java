...
// // GenericJacksonJsonRedisSerializer jsonRedisSerializer = new
// GenericJacksonJsonRedisSerializer(new ObjectMapper());
// // GenericJacksonJsonRedisSerializer jsonRedisSerializer =
// GenericJacksonJsonRedisSerializer.builder().build();
// // JacksonJsonRedisSerializer jsonRedisSerializer = new JacksonJsonRedisSerializer(Object.class);
